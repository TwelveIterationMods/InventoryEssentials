...
public class ModKeyMappings {
    ...
    public static void initialize() {
        ...
        keyBulkTransferSingle = Kuma.createKeyMapping(new ResourceLocation(InventoryEssentials.MOD_ID, "bulk_transfer_single"))
        ...
        keySortInventory = Kuma.createKeyMapping(new ResourceLocation(InventoryEssentials.MOD_ID, "sort_inventory"))
